...
class ThankYou extends Component {
  render() {
    const {
      brand, date, last4, price, size,
    } = this.props.pInfoReducer.pInfo;
        ...
        <div className="thankYouBackground">
          ...
          <div className="section1">
            <div className="section1Text">
              ...
              <div className="oneFortyCanvasText thankYouRounded bigScreenThankYou">
                A custom canvas from 140 Canvas
              </div>
              <div className="oneFortyCanvasText thankYouRounded smallScreenThankYou">
                A custom canvas
              </div>
          ...
          <div className="section3">
            <div className="thankYouRounded thankYouCTA">
              When your canvas arrives send a tweet with a photo to{' '}
              <span className="blueThankYouCTA">@140_Canvas</span> and we’ll send a box of
              chocolates to your address<span className="blueThankYouCTA" /> 💝
            </div>
          </div>
          <div className="section4">
            <div className="thankYouBook thankYouCTA extraWidth">
              We’ve sent confirmation of your order via email. If nothing arrives please check your
              junk mail.
            </div>
          </div>
        </div>
