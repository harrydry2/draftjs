...
const Page1 = () => (
  <div className="page1Wrapper">
    ...
    <img
      src="https://s3.eu-west-2.amazonaws.com/lifeishappening/finalLogoUnlessCompress.png"
    ...
    <div className="bodyContainer">
      ...
      <div className="bodyText gothamBook animatedBody">
        ...
        Christmas.<br /> Order your custom canvas before the 15th December for free delivery 🎁
      </div>
