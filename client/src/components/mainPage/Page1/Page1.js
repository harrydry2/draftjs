		...
		return (
			<div className="page1Wrapper">
				...
				<div className="bodyContainer">
					...
					<div className="bodyText gothamBook animatedBody">We create Twitter style canvases from whoever, for whoever. Pick your tweet, sender, favourites and retweets and we’ll do the rest!</div>
